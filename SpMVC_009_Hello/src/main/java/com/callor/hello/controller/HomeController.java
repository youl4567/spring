...
public class HomeController {
	 ...
	 * /WEB-INF/views/home.jsp 파일을 렌더링하여 
	 * HTML 코드로 변환한 후 응답하라
	 */
	...
	public String home(Model model) {
		...
		// Model model 객체
		// jsp 파일을 렌더링할 때 사용할 데이터를 보내기 위한 장바구니
		// NATION 이라는 이름의 변수에 '대한민국' 문자열을 담아서 JSP에게 보내겠다.
	 ...
	 * 각각 name 속성이 변수로 변환되어 Controller 의 method로 전달된다.
	 */
