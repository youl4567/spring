...
public class HomeController {
	 ...
	 * 인터페이스를 통해서 객체를 선언함으로써 
	 * 결합도는 낮아지고 코드 응집도가 높아져서
	 * 코드를 확장하고자 할 때 유리한 패턴이 된다.
	 */
	...
	public String home(Locale locale, Model model) {
		 ...
		 * 메서드를 사용하는 HomeController 작성자는 
		 * 아직 HomeServiceImpl 클래스의 메서드들이 구체적으로 완성이 되지 않았지만
	 ...
	 * 클래스 타입의 객체를 사용하여 메서드간의 데이터를 보내면
