...
public class BookServiceImplV1 implements BookService{
	...
	public void create_book_table() {
		...
		try {
			 ...
			 * Service 클래스에 Autowired 된 메서드를 선언하고
			 * 자동으로 실행되도록 한다.
			 */
	...
	public int insert(BookVO vo) {
		 ...
		 * INSERT 된 데이터의 행 개수를 리턴한다.
		 * 만약 리턴된 값이 0 이라면 한 개의 데이터도 INSERT 하지 못한 것이다
