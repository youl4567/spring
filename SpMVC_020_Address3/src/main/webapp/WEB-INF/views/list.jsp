...
<script src="${rootPath}/static/list.js?ver=2022-07-20"></script>
</head>
<body>
	<h1>반갑습니다</h1>
	
	<%// form에 한개의 input box 만 있을 경우 input box text 를 입력한 후 ENTER 를 누르면
	  // input box에 담긴 문자열을 서버로 전송하는 기능이 활성화 된다.
	%>
	<form>
