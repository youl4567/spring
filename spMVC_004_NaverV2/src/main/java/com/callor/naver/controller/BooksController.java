...
public class BooksController {
	...
	public String list(Model model) {
		/*
		 * return null 형식은
		 * 암시적으로 어떤 jsp 파일을 rendering 할 것인지 알려주는 것이다
	 ...
	 * GET 요청이나 POST 요청을 모두 처리하는 메서드가 되어버린다.
	 * 
	 * method = RequestMethod.GET 로 지정을 하면
	 * a tag link 를 눌렀을 때의 요청만 처리하도록 역할을 제한한다.
	 */
	...
	/*
	 * form tag method=POST 가 부착된 form 으로 감싼 데이터들이 전송되었을 때
	 * 요청을 받아 처리할 메서드.
	 */
