...
public class MemoController {
	...
	/*
	 * 첨부파일이 있는 프로젝트에서
	 * form 의 file input box type 의 이름은 절대 VO(DTO) 클래스에
	 * 선언된 이름을 사용하면 안된다. 
	 */
	@RequestMapping(value="/insert", method=RequestMethod.POST)
	public String insert(@ModelAttribute("memo")
							MemoDTO memo, MultipartFile file, HttpSession httpSession) {
	...
	public String update(
			...
			@ModelAttribute("memo") MemoDTO memoDTO, MultipartFile file,
				 HttpSession httpSession) {
