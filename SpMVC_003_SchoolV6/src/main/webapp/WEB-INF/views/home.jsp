...
header {
	/* important 어떤 태그 속성보다 우선적으로 강제적용 */
	background-color: green !important;
	padding: 2rem;
	font-weight: 900;
	/* 
	header 태그에 속성을 지정하면
	header가 감싸고 있는 태그들에게 속성이 상속되어 공통으로 적용된다.
	 */
	text-align: center;
...
/*
	a 태그의 컬러 속성은
	부모 태그의 컬러 속성을 상속받지 않는다.
	만약 a 태그에 부모의 컬러 속성을 상속받고자 한다면
...
<body>
	...
	<footer>
		<address>CopyRight &copy; windowyoul@gmail.com</address>
	</footer>
</body>
</html>